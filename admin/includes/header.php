...
$siteLogoImage = getSetting('site_logo_image', '/uploads/settings/logo.webp');
$unreadEnquiries = dbFetchOne("SELECT COUNT(*) as c FROM enquiries WHERE status = 'New'")['c'] ?? 0;
$unreadMessages = dbFetchOne("SELECT COUNT(*) as c FROM contact_messages WHERE status = 'New'")['c'] ?? 0;
...
<head>
    ...
    <script>(function(){var t=localStorage.getItem('theme');if(!t){var h=new Date().getHours();t=h>=6&&h<18?'light':'dark';}document.documentElement.setAttribute('data-theme',t);})();</script>
    ...
    <style>
        ...
        [data-theme="light"] {
            ...
            --accent: #2cb810;
            --accent-dark: #259e0e;
            --accent-glow: rgba(44,184,16,0.12);
            --danger: #dc3545;
            --warning: #f59e0b;
            --success: #2cb810;
        }
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
            ...
            .theme-toggle-admin { display: none; }
        }
    ...
    <div class="admin-main">
        <div class="admin-topbar">
            ...
            <div class="topbar-right">
                <button class="theme-toggle-admin" onclick="toggleTheme()" aria-label="Toggle theme" style="background:none;border:1px solid var(--border);border-radius:6px;width:32px;height:32px;display:flex;align-items:center;justify-content:center;cursor:pointer;color:var(--muted);">
                    ...
                    <style>[data-theme="dark"] .theme-toggle-admin .theme-icon-sun{display:block}[data-theme="dark"] .theme-toggle-admin .theme-icon-moon{display:none}[data-theme="light"] .theme-toggle-admin .theme-icon-sun{display:none}[data-theme="light"] .theme-toggle-admin .theme-icon-moon{display:block}</style>
                </button>
