...
$categories = dbFetchAll("SELECT faq_categories.*, (SELECT COUNT(*) FROM faqs WHERE faq_category_id=faq_categories.id) as faq_count FROM faq_categories ORDER BY sort_order");
