...
.prod-desc-3d-box h3{font-family:var(--font-heading);font-size:clamp(1.1rem,2vw,1.4rem);font-weight:600;color:var(--text-primary);margin:24px 0 12px;line-height:1.3}
...
.prod-desc-3d-box li{font-size:clamp(0.88rem,1vw,0.95rem);color:var(--text-secondary);line-height:1.7;margin-bottom:10px;position:relative;padding-left:16px}
...
<section class="section" style="padding-top:40px;">
    <div class="container">
        ...
        <div class="product-tabs" style="margin-top:60px;">
            ...
            <div class="product-tab-panel active" id="tab-description"><div class="page-content"><?php
if ($product['full_description']) {
    echo htmlspecialchars_decode($product['full_description'], ENT_QUOTES);
} else {
    $pn = e($product['title']);
    echo '<p>As a leading <strong>USA-based manufacturing company</strong>, we specialize in producing premium custom ' . $pn . ' that meet the highest standards of quality and craftsmanship. Our state-of-the-art manufacturing facility combines traditional expertise with modern technology to deliver exceptional results for brands nationwide.</p>
<p>When you choose us as your <strong>custom apparel manufacturer USA</strong>, you benefit from premium quality materials, expert craftsmanship, fully custom solutions tailored to your specifications, competitive factory-direct pricing, and reliable worldwide shipping with real-time tracking.</p>
<p>Whether you need custom ' . $pn . ' for your brand, retail store, team uniforms, or business operations, our <strong>USA-based manufacturing company</strong> is your trusted partner for consistent quality, on-time delivery, and complete satisfaction.</p>';
}
?></div></div>
            <?php if ($product['features']): ?>
