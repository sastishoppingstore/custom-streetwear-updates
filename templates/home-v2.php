...
<div class="first-look-elements" style="position:fixed;top:100px;right:20px;z-index:99;pointer-events:none;display:flex;flex-direction:column;align-items:flex-end;gap:10px;">
...
<!-- Hero Slider with 3D Parallax & Psychology -->
<section class="hero-slider hero-3d-wrapper" id="heroSlider">
    ...
    <div class="hero-slide <?php echo $index === 0 ? 'active' : ''; ?>">
        ...
        <div class="container">
            <div class="hero-slide-content">
                ...
                <div class="hero-layer hero-layer-1" style="margin-bottom:20px;">
                    <div class="live-stat" style="animation:fadeInUp 0.6s ease both;margin-right:12px;">
                        <span class="live-indicator"></span>
                        <span><strong class="live-stat-count">24</strong> people viewing now</span>
                    </div>
                    <div class="countdown-timer" style="animation:fadeInUp 0.6s ease 0.1s both;">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                        <span>Limited offer ends in <strong class="countdown-time">14:59</strong></span>
                    </div>
                </div>
                <?php endif; ?>
                <div class="hero-layer hero-layer-2">
                    <span class="hero-label" style="display:inline-block;animation:fadeInUp 0.6s ease 0.2s both;"><?php echo e($slide['subtitle']); ?></span>
                    <h1 class="hero-title" style="animation:fadeInUp 0.6s ease 0.3s both;"><?php echo nl2br(e($slide['title'])); ?></h1>
                    <p class="hero-desc" style="animation:fadeInUp 0.6s ease 0.4s both;"><?php echo e($slide['description']); ?></p>
                </div>
                <div class="hero-layer hero-layer-3 hero-buttons" style="animation:fadeInUp 0.6s ease 0.5s both;">
                    <a href="<?php echo e($slide['button_link']); ?>" class="btn btn-primary btn-lg magnetic-area"><?php echo e($slide['button_text']); ?></a>
                    <a href="#categories" class="btn btn-outline btn-lg magnetic-area">Explore Products</a>
                </div>
            </div>
        </div>
    </div>
